...
def gen_base_halo_data(partdata_filelist,partdata_filetype,vr_filelist,vr_filetype,tf_filelist,outname='',temporal_idval=10**12):
    ...
    * items will be removed from V1 file
    ...
    fields_to_keep=['Count','Snap','Structuretype','numSubStruct','ID','hostHaloID','Tail','Head','VR_FilePath','VR_FileType','Part_FilePath','Part_FileType','UnitInfo','SimulationInfo','outname','Xc','Yc','Zc','VXc','VYc','VZc','R_200crit','M_200crit','Vmax']
            ...
            if 'M_rel' in extra_halo_fields:
                ...
                for ihalo in range(n_halos_snap):
                    ...
                    if not hostID_temp==-1:
                        ...
                        sub_M=new_halo_data_snap['Mass_200crit_excl'][ihalo]
