...
def gen_base_halo_data(partdata_filelist,partdata_filetype,vr_filelist,vr_filetype,tf_filelist,add_descen=False,add_progen=True,numsnaps=None,outname='',temporal_idval=10**12):
    ...
    * items will be removed from V1 file
    ...
    base_fields=['ID','hostHaloID','Mass_tot','Mass_FOF','Structuretype',"numSubStruct",'Xc','Yc','Zc','Xcminpot','Ycminpot','Zcminpot','Xcmbp','Ycmbp','Zcmbp','VXc','VYc','VZc','R_200crit','R_200mean','Mass_200crit','Vmax','cNFW']#default halo fields
    ...
    fields_to_keep=['Count','Snap','Structuretype','numSubStruct','ID','hostHaloID','Tail','Head','VR_FilePath','VR_FileType','Part_FilePath','Part_FileType','PartHist_FilePath','UnitInfo','SimulationInfo','outname','Xc','Yc','Zc','Xcminpot','Ycminpot','Zcminpot','VXc','VYc','VZc','R_200crit','R_200mean','Mass_200crit','Vmax','cNFW']
