...
#################################################################### V3 FUNCTIONS: MULTIPROCESSING & PROGENITOR FINDING #############################################################################


def gen_accretion_rate_3(halo_data_all,snap,npart,mass_table,halo_cap=[],halo_index_list=[],depth=5,trim_particles=True,verbose=1): 
