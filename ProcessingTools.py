        ...
        for origin in origins:
            ...
            for prop in props:
                for snapstr in ['s1','s2']:
                    for ave in ['ave','med','lop','hip','logave','logmed','loglop','loghip','fzero']:
        ...
        for ihalo in valid_ihalo:
            ...
            for origin in origins:
                ...
                try:
                    ...
                    print(ihalo_group['Inflow']['PartType0']['snap1_Structure'].value[masks[origin]])
                    print(ihalo_group['Inflow']['PartType0']['snap1_Processed'].value[masks[origin]])
